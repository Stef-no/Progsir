...
TEST_CASE("Contagion generate_data returns the expected results") {
  ...
  Contagion test_cont{initial_state, 'y', 0, 180, 1, 'n', 0, 1, 'n', 0, 1, 0, 1, 1, 'n'};
  int duration{10};
  std::vector<PandemicData> expected_data{
      {1000, 10,  0,   0,   0,   0, 0.3, 0.05, 0.5,      0.3},
      {997,  12,  1,   0,   1,   0, 0.3, 0.05, 0.5,      0.3},
      {696,  15,  2, 297, 299,   0, 0.3, 0.05, 0.498078, 0.3},
      {485,  17,  3, 505, 508,   0, 0.3, 0.05, 0.496164, 0.3},
      {546,  18,  4, 442, 446, 297, 0.3, 0.05, 0.494257, 0.3},
      {525,  20,  5, 460, 465, 208, 0.3, 0.05, 0.492357, 0.3},
      {529,  22,  6, 453, 459, 234, 0.3, 0.05, 0.490465, 0.3},
      {526,  24,  7, 453, 460, 226, 0.3, 0.05, 0.48858,  0.3},
      {524,  27,  8, 451, 459, 227, 0.3, 0.05, 0.486702, 0.3},
      {521,  30,  9, 450, 459, 226, 0.3, 0.05, 0.484832, 0.3},
      {518,  33, 10, 449, 459, 225, 0.3, 0.05, 0.482968, 0.3}};
